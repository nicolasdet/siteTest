 ...
 * @author girish
 *
 * Source : http://stackoverflow.com/questions/6529026/codeigniter-default-controller-in-a-sub-directory-not-working
 * Par défaut dans CI, pas possible de définir une route pour l'accueil (default_controller) qui se trouve dans un sous-dossier
 */
